...
get_P_logistic <- function(theta, number_of_loci, number_of_clusters, eps = 0) {
    .Call('_disclapmix2_get_P_logistic', PACKAGE = 'disclapmix2', theta, number_of_loci, number_of_clusters, eps)
}

get_P <- function(theta, number_of_loci, number_of_clusters, link) {
...
precompute_dlm_powers <- function(p_by_cluster_and_locus) {
    .Call('_disclapmix2_precompute_dlm_powers', PACKAGE = 'disclapmix2', p_by_cluster_and_locus)
}
...
neg_loglik_theta <- function(theta, db, y, number_of_1_loci, number_of_2_loci, link) {
    .Call('_disclapmix2_neg_loglik_theta', PACKAGE = 'disclapmix2', theta, db, y, number_of_1_loci, number_of_2_loci, link)
}
...
neg_loglik_theta_ns <- function(theta, db, y, pi, q, number_of_1_loci, number_of_2_loci, link) {
    .Call('_disclapmix2_neg_loglik_theta_ns', PACKAGE = 'disclapmix2', theta, db, y, pi, q, number_of_1_loci, number_of_2_loci, link)
}
